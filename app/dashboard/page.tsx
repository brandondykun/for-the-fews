  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
        <Header title="Dashboard" showSignOut={true} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <GradientBorder width={1} roundedSize="xl">
                <Card className="dark:bg-neutral-800 dark:border-neutral-700">
                  <CardHeader>
                    ...
                    <CardDescription className="dark:text-neutral-300">
                      Interact with different themed AI assistants for
                      hilariously helpful conversations
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Link href="/llm-chat">
              ...
              <Card className="dark:bg-neutral-800 dark:border-neutral-700">
                <CardHeader>
                  ...
                  <CardDescription className="dark:text-neutral-300">
                    Connect with other selected Few users in real-time
                    conversations
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="dark:bg-neutral-800 dark:border-neutral-700">
                <CardHeader>
                  ...
                  <CardDescription className="dark:text-neutral-300">
                    Play fun games by yourself or with your fellow Few members
                    (in the works)
                  </CardDescription>
                </CardHeader>
                <CardContent>
