      ...
      {message.loading ? (
        ...
        <>
          <Image
            ...
            unoptimized={true}
          />
          <div className="absolute top-0 left-0 w-full h-full bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-center p-4 text-neutral-50">
